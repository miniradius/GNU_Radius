...
#define YYSTYPE         UYYSTYPE
/* Substitute the variable and function names.  */
#define yyparse         uyyparse
#define yylex           uyylex
#define yyerror         uyyerror
#define yydebug         uyydebug
#define yynerrs         uyynerrs
#define yylval          uyylval
#define yychar          uyychar
...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_descr = 19,                     /* descr  */
  YYSYMBOL_npairlist = 20,                 /* npairlist  */
  YYSYMBOL_pairlist = 21,                  /* pairlist  */
...
# endif
     ...
     && (! defined __cplusplus \
         || (defined UYYSTYPE_IS_TRIVIAL && UYYSTYPE_IS_TRIVIAL)))
...
{
       0,    86,    86,    87,    90,    93,    94,   100,   104,   116,
     122,   129,   133,   136,   137,   148,   152,   158,   162,   166,
     170,   174,   178,   184,   185
};
#endif
...
{
  "\"end of file\"", "error", "\"invalid token\"", "EQ", "LT", "GT", "NE",
  "LE", "GE", "NUL", "BOGUS", "STRING", "QUOTE", "','", "$accept", "input",
  "list", "entry", "user", "descr", "npairlist", "pairlist", "pair", "op",
  "value", YY_NULLPTR
};
...
#define yyclearin       (yychar = UYYEMPTY)
...
/* Backward compatibility with an undocumented macro.
   Use UYYerror or UYYUNDEF. */
#define YYERRCODE UYYUNDEF
...
#define YYPOPSTACK(N)   (yyvsp -= (N), yyssp -= (N))
  ...
  yychar = UYYEMPTY; /* Cause a token to be read.  */
...
yyreduce:
  ...
  switch (yyn)
    {
  case 4: /* list: entry  */
#line 91 "users-gram.y"
           {
	   }
#line 1422 "users-gram.c"
    break;

  case 6: /* list: list error  */
#line 95 "users-gram.y"
           {
		   grad_parser_lex_sync(); yyerrok; yyclearin;
	   }
#line 1430 "users-gram.c"
    break;

  case 7: /* entry: user descr  */
#line 101 "users-gram.y"
           {
		   add_entry(closure, &start_loc, (yyvsp[-1].string), (yyvsp[0].descr).lhs, (yyvsp[0].descr).rhs);
	   }
#line 1438 "users-gram.c"
    break;

  case 8: /* entry: user error  */
#line 105 "users-gram.y"
           {
		   grad_log(GRAD_LOG_ERR, _("discarding user `%s'"), (yyvsp[-1].string));
...
#line 1452 "users-gram.c"
    break;

  case 9: /* user: value  */
#line 117 "users-gram.y"
           {
		   start_loc = grad_parser_source_locus;
	   }
#line 1460 "users-gram.c"
    break;

  case 10: /* descr: npairlist npairlist  */
#line 123 "users-gram.y"
           {
		   (yyval.descr).lhs = (yyvsp[-1].pair);
		   (yyval.descr).rhs = (yyvsp[0].pair);
	   }
#line 1469 "users-gram.c"
    break;

  case 11: /* npairlist: NUL  */
#line 130 "users-gram.y"
           {
		   (yyval.pair) = NULL;
	   }
#line 1477 "users-gram.c"
    break;

  case 14: /* pairlist: pairlist ',' pair  */
#line 138 "users-gram.y"
           {
		   if ((yyvsp[-2].pair)) {
			   if ((yyvsp[0].pair))
				   grad_avl_add_list(&(yyvsp[-2].pair), (yyvsp[0].pair));
			   (yyval.pair) = (yyvsp[-2].pair);
		   } else
			   (yyval.pair) = (yyvsp[0].pair);
	   }
#line 1490 "users-gram.c"
    break;

  case 15: /* pair: STRING op value  */
#line 149 "users-gram.y"
           {
		   (yyval.pair) = grad_create_pair0((yyvsp[-2].string), (yyvsp[-1].op), (yyvsp[0].string));
	   }
#line 1498 "users-gram.c"
    break;

  case 16: /* pair: STRING op BOGUS  */
#line 153 "users-gram.y"
           {
		   YYERROR;
	   }
#line 1506 "users-gram.c"
    break;

  case 17: /* op: EQ  */
#line 159 "users-gram.y"
           {
		   (yyval.op) = grad_operator_equal;
	   }
#line 1514 "users-gram.c"
    break;

  case 18: /* op: LT  */
#line 163 "users-gram.y"
           {
		   (yyval.op) = grad_operator_less_than;
	   }
#line 1522 "users-gram.c"
    break;

  case 19: /* op: GT  */
#line 167 "users-gram.y"
           {
		   (yyval.op) = grad_operator_greater_than;
	   }
#line 1530 "users-gram.c"
    break;

  case 20: /* op: NE  */
#line 171 "users-gram.y"
           {
		   (yyval.op) = grad_operator_not_equal;
	   }
#line 1538 "users-gram.c"
    break;

  case 21: /* op: LE  */
#line 175 "users-gram.y"
           {
		   (yyval.op) = grad_operator_less_equal;
	   }
#line 1546 "users-gram.c"
    break;

  case 22: /* op: GE  */
#line 179 "users-gram.y"
           {
		   (yyval.op) = grad_operator_greater_equal;
	   }
#line 1554 "users-gram.c"
    break;


#line 1558 "users-gram.c"
...
yyerrlab:
  ...
  yytoken = yychar == UYYEMPTY ? YYSYMBOL_YYEMPTY : YYTRANSLATE (yychar);

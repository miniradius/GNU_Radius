...
/* Encode object length.
   ...
   Error: NULL */
u_char *
asn_encode_length(u_char *data, u_int *datalength, u_int length)
{
	if (*datalength < 1) {
...
/* Build an ASN header.
   ...
   Error: NULL */
u_char *
asn_encode_header(u_char *data, u_int *datalength, u_char type, int length)
{
	if (*datalength < 1) {
		SNMP_SET_ERRNO(E_ASN_ENCODE);
		return (NULL);
...
u_char *
asn_decode_header(u_char *data, u_int *datalength, u_char *type)
{
	if (*datalength < 1) {
		SNMP_SET_ERRNO(E_ASN_DECODE);
		return (NULL);
...
u_char *
asn_encode_null(u_char *data, u_int *datalength, u_char type)
{
...
/* Decode an integer object.
   ...
   Error: NULL */
u_char *
asn_decode_int(u_char *data, u_int *datalength, u_char *type,
...
u_char *
asn_encode_int(u_char *data, u_int *datalength, u_char type, int intval)
{
	u_int mask;
...
/* Decode a string object.
   ...
   Error: NULL */
u_char *
asn_decode_string(u_char *data, u_int *datalength, u_char *type,
		  u_char *string, u_int *strlength)
{
	u_char *buf = data;
	u_int count;
...
/* build an ASN object containig a string.
   ...
   Error: NULL */
u_char *
asn_encode_string(u_char *data, u_int *datalength, u_char type,
		  u_char *string, u_int strlength)
{
...
/* Decode an oid object.
   ...
   Error: NULL */
u_char *
asn_decode_oid(u_char *data, u_int *datalength, u_char *type,
	       oid_t obid, u_int *obidlength)
{
	u_char *buf = data;
	u_int count;
	u_int subid;
...
/* build an ASN object containig an oid.
   ...
   Error: NULL */
u_char *
asn_encode_oid(u_char *data, u_int *datalength, u_char type,
	       oid_t obid, u_int obidlength)
{
	u_int length;
	u_char *buf, *bp;
